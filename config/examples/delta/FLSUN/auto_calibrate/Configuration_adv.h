...
<<<<<<< HEAD:config/examples/delta/FLSUN/auto_calibrate/Configuration_adv.h
=======
  ...
  //#define MARLIN_SNAKE
>>>>>>> upstream/bugfix-2.0.x:config/examples/delta/FLSUN/auto_calibrate/Configuration_adv.h
