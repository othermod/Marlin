...
<<<<<<< HEAD:config/examples/delta/Geeetech/Rostock 301/Configuration_adv.h
=======
  ...
  //#define MARLIN_SNAKE
>>>>>>> upstream/bugfix-2.0.x:config/examples/delta/Geeetech/Rostock 301/Configuration_adv.h
